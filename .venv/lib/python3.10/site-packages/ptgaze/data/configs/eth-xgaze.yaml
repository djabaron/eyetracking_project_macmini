...
demo:
  use_camera: true
  #camera id = 0 for using the default cam (build-in camera of laptop)
  #camera id = 1 for using an external USB Webcam or for using the external smartphone cam (using Wifi Connection via "Camo Studio"
  camera_id: 1
